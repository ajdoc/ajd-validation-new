...
abstract class ExpressionDefinition
{
    /**
    ...
    final public const SCHEMA = [
        '@name'        => 'equals',
        '@arguments'   => ['string'],
        '@callback'    => [LogicComparator::class, 'isEqual'],
    ...
    protected const DEFAULT = [
        '@name'        => 'rule',
        '@arguments'   => [],
        '@callback'    => [LogicComparator::class, 'return'],
        '@parameters'  => ['@input'],
        '@comparison'  => ['@output', '&&', true],
        '@variables'   => ['@label' => 'The field', '@extra' => []],
     ...
     * @return void
     *
     * @throws InvalidArgumentException If the rule definition is invalid.
     */
